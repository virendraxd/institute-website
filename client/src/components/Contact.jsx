    ...
    <section id="contact" className="section-padding bg-(--bg-secondary)">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-12">
        ...
        <div className="space-y-8">
          <div>
            <h3 className="text-2xl font-bold text-(--primary-accent) mb-6">Get in Touch</h3>
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 bg-white rounded-xl shadow-sm flex items-center justify-center shrink-0">
                <svg className="w-6 h-6 text-(--secondary-accent)" fill="none" viewBox="0 0 24 24" stroke="currentColor">
